...
function buildTheme(
	...
	if (accentChroma === 0) primaryLightness = dark ? 0.88 : 0.28
	else primaryLightness = dark ? 0.74 : 0.59
...
export function buildWallpaperPalette(
	pixels: readonly Rgb[],
