...
const theme_page = < Page name="Theme" icon={icons.ui.themes} >
	<Group title="Theme">
		<Wallpaper />
...
const bar_page = <Page name="Bar" icon={icons.ui.minus}>
	<Group title="General">
...
const general_page = < Page name="General" icon={icons.ui.settings} >
